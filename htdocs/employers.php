    ...
    <header id="header" class="hoc clear">
      ...
      <nav id="mainav" class="fl_right"> 
        ...
        <ul class="clear">
          ...
          <li class="active"><a class="drop" href="employers.php">&nbsp;Εργοδοτες</a>
            <ul>
...
<div class="wrapper bgded overlay gradient" style="z-index: 1; background-color:rgb(0, 0, 0);">
    <div id="breadcrumb" class="hoc clear"> 
      <ul>
        ...
        <li class="active"> <a href="ergazomenoi.php" style="font-size: inherit;">ΕΡΓΟΔΟΤΕΣ</a></li>
      </ul>
    </div>
</div>
 ...
 <div class="one_quarter first" style="position: fixed; top: 300px; left: 90px; z-index: 3;">
    ...
    <?php
      if(isset($_SESSION["loggedin"]) && $_SESSION["role_id"]==2){
        echo '<li><a href="employer_profile/mybusiness.php#ergazomenoi">Δήλωση της αποστάσεως εργασίας</a></li>
              <li><a href="employer_profile/mybusiness.php#ergazomenoi">Δήλωση της αναβολής εργασίας</a></li>';
      }
      else{
        echo '<li><a href="status_reports/login_notification.php">Δήλωση της αποστάσεως εργασίας</a></li>
              <li><a href="status_reports/login_notification.php">Δήλωση της αναβολής εργασίας</a></li>';
      }
    ?>
      <li><a href="#">Ρύθμιση οφειλών</a></li>
...
<div class="wrapper row2" style="min-height:57.6vh;">
  <section class="hoc container clear"> 
    <div class="one_quarter first" style="opacity: 0;">
      <h1>Ηλεκτρονικές υπηρεσίες</h1>
      <ul class="clear">
        <li><a href="status_reports/login_notification.php">Δήλωση της αποστάσεως εργασίας</a></li>
        <li><a href="status_reports/login_notification.php">Δήλωση της αναβολής εργασίας</a></li>
        <li><a href="#">Ρύθμιση οφειλών</a></li>
        <li><a href="#">Υπολογισμός έκπτωσης ασφαλιστικών εισφορών</a></li>
      </ul>
      ...
      <ul class="nospace group prices">
        <li class="one_third ">
          <article><i class="fas fa-exclamation"></i>
            ...
            <footer><a class="btn" href="covid.php/ergodoths">Περισσότερα</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article style="min-height: 350px;"><i class="fas fa-book"></i>
            <h1 class="heading">Ασφαλιστικός οδηγός</h1>
        ...
        <li class="one_third" >
          <article style="min-height: 350px;"><i class="fas fa-piggy-bank"></i>
            <h1 class="heading">Οικονομική καρτέλα</h1>
            <p>Οικονομικά στοιχεία που αφορούν στις κινήσεις για το αιτούμενο χρονικό διάστημα </p>
  ...
  <main class="hoc clear"> 
    ...
    <div class="content three_quarter first min_info">
      <div class="flex_row">
        <img class="single_logo" src="../images/logo_big.png" alt="Λόγκο Υπουργείο Εργασίας">
